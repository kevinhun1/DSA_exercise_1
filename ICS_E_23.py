...
if __name__ == "__main__":
    ...
    checkout(disc_cart)  # Added logic to print the discounted cart

    # 3) Applying Tax
    taxed_cart = TaxedCart(tax_rate=0.12)  # Corrected tax rate to 12% as per the print statement
    ...
    checkout(taxed_cart)  # Added logic to print the taxed cart